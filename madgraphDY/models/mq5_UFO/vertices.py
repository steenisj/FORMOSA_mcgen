...
V_154 = Vertex(name = 'V_154',
              particles = [ P.mq__plus__, P.mq__minus__, P.a ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_3})

V_155 = Vertex(name = 'V_155',
               particles = [ P.mq__plus__, P.mq__minus__, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_88})
...
V_156 = Vertex(name = 'V_156',
               particles = [ P.mq__plus__, P.mq__minus__, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_89})

V_157 = Vertex(name = 'V_157',
               particles = [ P.mq__plus__, P.mq__minus__, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV4 ],
               couplings = {(0,0):C.GC_50,(0,1):C.GC_59})
