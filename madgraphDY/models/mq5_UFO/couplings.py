...
GC_201 = Coupling(name = 'GC_201',
                # value = '-(ee*complex(0,1))',
                # value = '({}*ee*cw*complex(0,1))'.format(k),
                # value = '(K*ee*cw*complex(0,1))', # need kappa=1.4 and 13tev to match 14tev
                value = '(K*ee*complex(0,1))', # need kappa=1 at 14tev
                order = {'QED':1})

# NOTE e e z 1
GC_202 = Coupling(name = 'GC_202',
                 # value = '-(cw*ee*complex(0,1))/(2.*sw)',
                 # value = '-({}*ee*sw*complex(0,1))'.format(k),
                 # value = '-(K*ee*sw*complex(0,1))', # need kappa=1.4 and 13tev to match 14tev
                 value = '-(K*ee*(sw/cw)*complex(0,1))', # need kappa=1 at 14tev
                 order = {'QED':1})

# # NOTE e e z 2
# GC_203 = Coupling(name = 'GC_203',
#                  # value = '(ee*complex(0,1)*sw)/(2.*cw)',
#                  value = '-0.5*({}*ee*sw*complex(0,1))'.format(k),
#                  order = {'QED':1})
