...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,300015,bn,mqmass,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,300015,bn,mqwidth,1d0)
       bn='mguser'
       call set_it(n,ivalue,value,name,1,bn,eps ,0d0)
       call set_it(n,ivalue,value,name,2,bn,gp  ,0d0)
      return
      end
