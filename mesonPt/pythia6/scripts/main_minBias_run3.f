...
!       random number generator for initialisation
...
!       set processes to include in generation
...
!     set seed
      MRPY(1) = 10
      open(1, file='../../rawFiles/minBiasDW.txt') 

C...Initialize for the LHC.
      CALL PYINIT('CMS','p','p',13600D0)
